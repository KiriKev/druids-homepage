...
const TR = {
  en: {
    ...
    "latest.eyebrow": "Lately",
    "latest.title": "Fresh from the reel.",
    "latest.lede": "The newest pieces, as they leave the studio. Short films and running brand content, side by side.",
    "latest.filter.all": "All",
    "latest.filter.brand": "Brands",
    "latest.filter.short": "Short films",
    "latest.kind.brand": "Brand",
    "latest.kind.short": "Short film",
    "latest.clips": "clips",
    "latest.ongoing": "ongoing",
    "latest.archive": "Full archive",
    "latest.archiveHint": "Every piece, filterable.",
    "latest.empty": "Nothing here yet.",
    "latest.prev": "Scroll back",
    "latest.next": "Scroll forward",
    "archive.eyebrow": "Archive",
    "archive.title": "Everything, in order.",
    "archive.back": "Back to the site",
    "services.recent": "See recent work",
    ...
    "approach.1.body": "As we discuss the brief, we set the stage and talk through the emotional cues you want featured. Goals, constraints, and what stayed off camera.",
    ...
    "approach.3.body": "Your vision: sharpened, never replaced. Iteration until the result feels like an extension of you.",
    "approach.4.title": "Connection",
    "approach.4.body": "Story is bonding. We build it deliberately so an audience can’t look away.",
    "approach.coda": "Backed by the expertise of copywriters who advise nine-figure brands, every script meets the highest standards before the planning of a single frame begins.",
    ...
    "services.4.lede": "Lighter workflows that give you back hours every day. Whether the work lives in spreadsheets or in AI tooling.",
    "services.4.b1": "Workflow audits: we find the routines worth automating",
    "services.4.b2": "Automation in Python, n8n or smart contracts for office, operations and payment tasks",
    "services.4.b3": "AI tools carefully woven into the systems you already use",
    "services.4.b4": "Outcome: hours come back, every day, to the work that actually matters",
    "services.5.title": "Decentralization and Finance",
    "services.5.lede": "Advisory on building projects in decentralized tech and finance. Right now I’m bringing two products of my own to market: Enki Art, the marketplace for artists, and a decentralized social-media app.",
    ...
    "award.of": "of 140",
    "award.eyebrow": "Animation / Competition · Recognition · PsyopAnime",
    "award.title": "Top 10% in a viral animation competition (out of 140 entrants).",
    "award.body": "Brief: design and execute an animation around a controversial storyline. Work delivered: fully directed the scenes from the original audio and composed the frames. Outcome: proved I can take on unconventional challenges of any difficulty or topic.",
    ...
    "brief.service.defi": "Decentralization & Finance",
  ...
  de: {
    ...
    "latest.eyebrow": "Zuletzt",
    "latest.title": "Frisch aus dem Schnitt.",
    "latest.lede": "Die neuesten Arbeiten, so wie sie das Studio verlassen. Kurzfilme und laufender Marken-Content, Seite an Seite.",
    "latest.filter.all": "Alle",
    "latest.filter.brand": "Marken",
    "latest.filter.short": "Kurzfilme",
    "latest.kind.brand": "Marke",
    "latest.kind.short": "Kurzfilm",
    "latest.clips": "Clips",
    "latest.ongoing": "laufend",
    "latest.archive": "Ganzes Archiv",
    "latest.archiveHint": "Jede Arbeit, filterbar.",
    "latest.empty": "Hier ist noch nichts.",
    "latest.prev": "Zurück blättern",
    "latest.next": "Weiter blättern",
    "archive.eyebrow": "Archiv",
    "archive.title": "Alles, der Reihe nach.",
    "archive.back": "Zurück zur Seite",
    "services.recent": "Aktuelle Arbeiten ansehen",
    ...
    "approach.1.body": "Während wir die Aufgabe besprechen, setzen wir die Bühne und gehen die emotionalen Akzente durch, die im Film auftauchen sollen. Ziele, Grenzen und das, was außerhalb des Bildes bleibt.",
    ...
    "approach.3.body": "Deine Vision: geschärft, nie ersetzt. Solange überarbeitet, bis das Ergebnis wie eine Fortsetzung von dir wirkt.",
    ...
    "approach.coda": "Dank der Expertise von Textern, die neunstellige Marken beraten, erfüllt jedes Drehbuch höchste Standards, bevor die Planung des ersten Bildes überhaupt beginnt.",
    ...
    "services.4.lede": "Leichtere Abläufe, die dir täglich Stunden zurückgeben. Egal ob die Arbeit in Tabellen oder in KI Werkzeugen steckt.",
    "services.4.b1": "Prozess-Audit: wir finden die Routinen, die sich zu automatisieren lohnen",
    "services.4.b2": "Automatisierungen mit Python, n8n oder Smart Contracts für Büro-, Betriebs- und Zahlungsaufgaben",
    "services.4.b3": "KI-Werkzeuge sorgsam in die bestehenden Systeme eingebunden",
    "services.4.b4": "Ergebnis: Zeit fließt jeden Tag dorthin zurück, wo sie wirklich zählt",
    "services.5.title": "Dezentralisierung und Finanzen",
    "services.5.lede": "Beratung beim Entwickeln von Projekten in dezentraler Technologie und Finanzwesen. Aktuell bringe ich zwei eigene Produkte auf den Markt: Enki Art, den Marktplatz für Künstler, und eine dezentrale Anwendung für soziale Netzwerke.",
    ...
    "award.of": "von 140",
    "award.eyebrow": "Animation / Wettbewerb · Anerkennung · PsyopAnime",
    "award.title": "Top 10% in einem viralen Animationswettbewerb (unter 140 Teilnehmern).",
    "award.body": "Aufgabe: Eine Animation rund um eine kontroverse Storyline konzipieren und umsetzen. Geleistete Arbeit: Die Szenen vollständig zur Originaltonspur inszeniert und die Bildkomposition entwickelt. Ergebnis: Bewiesen, dass ich mit unkonventionellen Aufgaben jeder Komplexität und Thematik umgehen kann.",
    ...
    "brief.service.defi": "Dezentralisierung & Finanzen",
  ...
  ru: {
    ...
    "latest.eyebrow": "Недавнее",
    "latest.title": "Свежее из монтажной.",
    "latest.lede": "Новые работы — сразу, как выходят из студии. Короткометражки и постоянный контент для брендов, рядом.",
    "latest.filter.all": "Все",
    "latest.filter.brand": "Бренды",
    "latest.filter.short": "Короткометражки",
    "latest.kind.brand": "Бренд",
    "latest.kind.short": "Короткий метр",
    "latest.clips": "клипов",
    "latest.ongoing": "продолжается",
    "latest.archive": "Весь архив",
    "latest.archiveHint": "Все работы, с фильтрами.",
    "latest.empty": "Пока пусто.",
    "latest.prev": "Назад",
    "latest.next": "Вперёд",
    "archive.eyebrow": "Архив",
    "archive.title": "Всё по порядку.",
    "archive.back": "Назад на сайт",
    "services.recent": "Смотреть свежие работы",
    ...
    "approach.1.body": "Обсуждая задачу, мы выстраиваем сцену и проговариваем эмоциональные акценты, которые ты хочешь увидеть в фильме. Цели, ограничения и то, что осталось за кадром.",
    ...
    "approach.3.body": "Твоё видение: заострённое, не подменённое. Доработки до тех пор, пока результат не станет продолжением твоего «я».",
    ...
    "approach.coda": "Благодаря экспертизе авторов, консультирующих бренды с девятизначными оборотами, каждый сценарий соответствует высочайшим стандартам ещё до начала планирования первого кадра.",
    ...
    "services.4.lede": "Более лёгкие процессы, которые освобождают вам часы каждый день. Будь то работа в таблицах или с ИИ инструментами.",
    "services.4.b1": "Аудит процессов: находим рутину, которую стоит автоматизировать",
    "services.4.b2": "Автоматизация на Python, n8n или смарт-контрактах для офисных, операционных и платёжных задач",
    "services.4.b3": "ИИ инструменты, аккуратно встроенные в ваши существующие системы",
    "services.4.b4": "Результат: время каждый день возвращается туда, где оно действительно важно",
    "services.5.title": "Децентрализация и финансы",
    "services.5.lede": "Консультирование по разработке проектов в области децентрализованных технологий и финансов. В настоящее время вывожу на рынок два собственных продукта: маркетплейс для художников Enki Art и децентрализованное приложение для соцсетей.",
    ...
    "award.of": "из 140",
    "award.eyebrow": "Анимация / Конкурс · Признание работы · PsyopAnime",
    "award.title": "Топ 10% в вирусном конкурсе анимации (среди 140 участников).",
    "award.body": "Задача: разработать и реализовать анимацию с остросюжетным кадром. Выполненная работа: полностью срежиссировал сцены под оригинальный звук и разработал композицию кадров. Результат: доказал способность успешно справляться с нестандартными вызовами любой сложности и тематики.",
    ...
    "brief.service.defi": "Децентрализация и финансы",
