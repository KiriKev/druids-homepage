...
const TR = {
  en: {
    ...
    "services.4.b2": "Spreadsheet automation: imports, reconciliation, reporting",
    ...
    "services.5.lede": "Advisory on building in decentralized tech and finance. I’m shipping two products of my own: Enki Art, the artist marketplace, and a decentralized social-media app for creators.",
    ...
    "services.5.b3": "Decentralized social media and creator monetization patterns",
    "services.5.b4": "Bringing artists into Web3 without the friction",
    ...
    "cta.sub": "One conversation. We’ll know in twenty minutes whether we’re building something together.",
  ...
  de: {
    ...
    "services.4.b2": "Tabellen-Automatisierung: Importe, Abgleiche, Auswertungen",
    ...
    "services.5.lede": "Beratung beim Bauen in dezentraler Technik und Finanzwesen. Aktuell baue ich zwei eigene Produkte: Enki Art, den Marktplatz für Künstler, und eine dezentrale Anwendung für soziale Netzwerke.",
    ...
    "services.5.b3": "Dezentrale soziale Netzwerke und Vergütungsmuster für Kreative",
    "services.5.b4": "Künstler ins Web3 holen, ohne Reibungsverluste",
    ...
    "cta.sub": "Ein Gespräch. In zwanzig Minuten wissen wir, ob wir gemeinsam etwas erschaffen.",
  ...
  ru: {
    ...
    "services.4.b2": "Автоматизация таблиц: импорт, сверки, отчёты",
    ...
    "services.5.lede": "Консультирование по созданию проектов в децентрализованных технологиях и финансах. Сейчас я выпускаю два собственных продукта: Enki Art — маркетплейс для художников, и децентрализованное приложение для социальных сетей.",
    ...
    "services.5.b3": "Децентрализованные социальные сети и модели монетизации для творцов",
    "services.5.b4": "Введение художников в Web3 без лишнего трения",
    ...
    "cta.sub": "Один разговор. За двадцать минут поймём, создаём ли мы что-то вместе.",
