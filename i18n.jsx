...
const TR = {
  en: {
    ...
    "reel.filter.all": "All",
    "reel.filter.brand": "Brands",
    "reel.filter.short": "Short films",
    "reel.kind.brand": "Brand",
    "reel.kind.short": "Short film",
    "reel.clips": "clips",
    "reel.ongoing": "ongoing",
    "reel.archive": "Full archive",
    "reel.archiveHint": "Every piece, filterable.",
    "reel.empty": "Nothing here yet.",
    "reel.prev": "Scroll back",
    "reel.next": "Scroll forward",
  ...
  de: {
    ...
    "reel.filter.all": "Alle",
    "reel.filter.brand": "Marken",
    "reel.filter.short": "Kurzfilme",
    "reel.kind.brand": "Marke",
    "reel.kind.short": "Kurzfilm",
    "reel.clips": "Clips",
    "reel.ongoing": "laufend",
    "reel.archive": "Ganzes Archiv",
    "reel.archiveHint": "Jede Arbeit, filterbar.",
    "reel.empty": "Hier ist noch nichts.",
    "reel.prev": "Zurück blättern",
    "reel.next": "Weiter blättern",
  ...
  ru: {
    ...
    "reel.filter.all": "Все",
    "reel.filter.brand": "Бренды",
    "reel.filter.short": "Короткометражки",
    "reel.kind.brand": "Бренд",
    "reel.kind.short": "Короткий метр",
    "reel.clips": "клипов",
    "reel.ongoing": "продолжается",
    "reel.archive": "Весь архив",
    "reel.archiveHint": "Все работы, с фильтрами.",
    "reel.empty": "Пока пусто.",
    "reel.prev": "Назад",
    "reel.next": "Вперёд",
